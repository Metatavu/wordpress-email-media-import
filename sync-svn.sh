...
rsync --recursive --exclude='.*' --exclude='.git' --exclude='tests' --exclude="composer.json" --exclude='sync-svn.sh' --exclude='releasen.sh' --exclude='svn' --exclude="wp" --exclude="vendor" . svn/trunk
